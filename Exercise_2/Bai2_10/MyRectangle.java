...
//  Phương thức này trả về một đối tượng MyPoint đại diện
//  cho điểm góc dưới bên trái của hình chữ nhật.
...
//   trả về tọa độ của góc dưới bên phải của hình chữ nhật
    public int[] getBottomRightXY(){
        return new int[]{this.bottomRight.getX(), this.bottomRight.getY()};
    }
//  trả về tọa độ điem ở dưới bên trai voi kieu tra ve la MyPoint
    public MyPoint getBottomLeft(){
        return new MyPoint(this.topLeft.getX(),this.bottomRight.getY());
    }
//    trả về tọa độ điem ở tren ben phai voi kieu tra ve la MyPoint
