...
//        ahTeck.setEmail("paulTan@nowhere"); // Test setter
...
//        System.out.println("gender is: " + ahTeck.getGender()); // Test getter
        ...
        Book anotherBool = new Book("more Java",new Author("Paul Tan","paul@somewhere.com",'m'),29.95);
        System.out.println(anotherBool); // toString()
    }
}
